...
class Footnotes_Layout_Settings extends Footnotes_Layout_Engine {
	...
	protected function get_sub_page_title() {
		return Footnotes_Config::PLUGIN_PUBLIC_NAME;
	}
	...
	protected function get_sections() {
		...
		$tabs[] = $this->add_section( 'how-to', __( 'Quick start guide', 'footnotes' ), null, false );
	...
	protected function get_meta_boxes() {
		...
		$meta_boxes[] = $this->add_meta_box( 'settings', 'love', Footnotes_Config::PLUGIN_HEADING_NAME . '&nbsp;' . Footnotes_Config::LOVE_SYMBOL_HEADING, 'love' );
	...
	public function amp_compat() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'settings-amp' );
		...
		$template->replace(
			array(
				...
				'label-amp'         => $this->add_label( Footnotes_Settings::FOOTNOTES_AMP_COMPATIBILITY_ENABLE, __( 'Enable AMP compatibility mode:', 'footnotes' ) ),
				'amp'               => $this->add_checkbox( Footnotes_Settings::FOOTNOTES_AMP_COMPATIBILITY_ENABLE ),
	...
	public function reference_container() {
		...
		// Options for the separating punctuation between backlinks.
			...
			// Load template file.
			$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'settings-reference-container' );
			// Replace all placeholders.
			$template->replace(
				array(
					'label-name'           => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_NAME, __( 'Heading:', 'footnotes' ) ),
					'name'                 => $this->add_text_box( Footnotes_Settings::REFERENCE_CONTAINER_NAME ),

					'label-element'        => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_LABEL_ELEMENT, __( 'Heading\'s HTML element:', 'footnotes' ) ),
					'element'              => $this->add_select_box( Footnotes_Settings::REFERENCE_CONTAINER_LABEL_ELEMENT, $label_element ),

					'label-border'         => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_LABEL_BOTTOM_BORDER, __( 'Border under the heading:', 'footnotes' ) ),
					'border'               => $this->add_select_box( Footnotes_Settings::REFERENCE_CONTAINER_LABEL_BOTTOM_BORDER, $enabled ),

					'label-collapse'       => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_COLLAPSE, __( 'Collapse by default:', 'footnotes' ) ),
					'collapse'             => $this->add_select_box( Footnotes_Settings::REFERENCE_CONTAINER_COLLAPSE, $enabled ),

					'label-script'         => $this->add_label( Footnotes_Settings::FOOTNOTES_REFERENCE_CONTAINER_SCRIPT_MODE, __( 'Script mode:', 'footnotes' ) ),
					'script'               => $this->add_select_box( Footnotes_Settings::FOOTNOTES_REFERENCE_CONTAINER_SCRIPT_MODE, $script_mode ),
					'notice-script'        => __( 'The plain JavaScript mode will enable hard links with configurable scroll offset.', 'footnotes' ),

					'label-position'       => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_POSITION, __( 'Default position:', 'footnotes' ) ),
					'position'             => $this->add_select_box( Footnotes_Settings::REFERENCE_CONTAINER_POSITION, $positions ),
					...
					'label-shortcode'      => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_POSITION_SHORTCODE, __( 'Position shortcode:', 'footnotes' ) ),
					'shortcode'            => $this->add_text_box( Footnotes_Settings::REFERENCE_CONTAINER_POSITION_SHORTCODE ),
					...
					'label-section'        => $this->add_label( Footnotes_Settings::FOOTNOTE_SECTION_SHORTCODE, __( 'Footnote section shortcode:', 'footnotes' ) ),
					'section'              => $this->add_text_box( Footnotes_Settings::FOOTNOTE_SECTION_SHORTCODE ),
					...
					'label-startpage'      => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_START_PAGE_ENABLE, __( 'Display on start page too:', 'footnotes' ) ),
					'startpage'            => $this->add_select_box( Footnotes_Settings::REFERENCE_CONTAINER_START_PAGE_ENABLE, $enabled ),

					'label-margin-top'     => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_TOP_MARGIN, __( 'Top margin:', 'footnotes' ) ),
					'margin-top'           => $this->add_num_box( Footnotes_Settings::REFERENCE_CONTAINER_TOP_MARGIN, -500, 500 ),
					'notice-margin-top'    => __( 'pixels; may be negative', 'footnotes' ),

					'label-margin-bottom'  => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_BOTTOM_MARGIN, __( 'Bottom margin:', 'footnotes' ) ),
					'margin-bottom'        => $this->add_num_box( Footnotes_Settings::REFERENCE_CONTAINER_BOTTOM_MARGIN, -500, 500 ),
					'notice-margin-bottom' => __( 'pixels; may be negative', 'footnotes' ),

					'label-page-layout'    => $this->add_label( Footnotes_Settings::FOOTNOTES_PAGE_LAYOUT_SUPPORT, __( 'Apply basic responsive page layout:', 'footnotes' ) ),
					'page-layout'          => $this->add_select_box( Footnotes_Settings::FOOTNOTES_PAGE_LAYOUT_SUPPORT, $page_layout_options ),
					'notice-page-layout'   => __( 'Most themes don\'t need this fix.', 'footnotes' ),

					'label-url-wrap'       => $this->add_label( Footnotes_Settings::FOOTNOTE_URL_WRAP_ENABLED, __( 'Allow URLs to line-wrap anywhere:', 'footnotes' ) ),
					'url-wrap'             => $this->add_select_box( Footnotes_Settings::FOOTNOTE_URL_WRAP_ENABLED, $enabled ),
					'notice-url-wrap'      => __( 'Unicode-conformant browsers don\'t need this fix.', 'footnotes' ),

					'label-symbol'         => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_BACKLINK_SYMBOL_ENABLE, __( 'Display a backlink symbol:', 'footnotes' ) ),
					'symbol-enable'        => $this->add_select_box( Footnotes_Settings::REFERENCE_CONTAINER_BACKLINK_SYMBOL_ENABLE, $enabled ),
					'notice-symbol'        => __( 'Please choose or input the symbol at the top of the next dashboard tab.', 'footnotes' ),

					'label-switch'         => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_BACKLINK_SYMBOL_SWITCH, __( 'Symbol appended, not prepended:', 'footnotes' ) ),
					'switch'               => $this->add_select_box( Footnotes_Settings::REFERENCE_CONTAINER_BACKLINK_SYMBOL_SWITCH, $enabled ),

					'label-3column'        => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_3COLUMN_LAYOUT_ENABLE, __( 'Backlink symbol in an extra column:', 'footnotes' ) ),
					'3column'              => $this->add_select_box( Footnotes_Settings::REFERENCE_CONTAINER_3COLUMN_LAYOUT_ENABLE, $enabled ),
					'notice-3column'       => __( 'This legacy layout is available if identical footnotes are not combined.', 'footnotes' ),

					'label-row-borders'    => $this->add_label( Footnotes_Settings::REFERENCE_CONTAINER_ROW_BORDERS_ENABLE, __( 'Borders around the table rows:', 'footnotes' ) ),
					'row-borders'          => $this->add_select_box( Footnotes_Settings::REFERENCE_CONTAINER_ROW_BORDERS_ENABLE, $enabled ),

					'label-separator'      => $this->add_label( Footnotes_Settings::BACKLINKS_SEPARATOR_ENABLED, __( 'Add a separator when enumerating backlinks:', 'footnotes' ) ),
					'separator-enable'     => $this->add_select_box( Footnotes_Settings::BACKLINKS_SEPARATOR_ENABLED, $enabled ),
					'separator-options'    => $this->add_select_box( Footnotes_Settings::BACKLINKS_SEPARATOR_OPTION, $separators ),
					'separator-custom'     => $this->add_text_box( Footnotes_Settings::BACKLINKS_SEPARATOR_CUSTOM ),
					'notice-separator'     => __( 'Your input overrides the selection.', 'footnotes' ),

					'label-terminator'     => $this->add_label( Footnotes_Settings::BACKLINKS_TERMINATOR_ENABLED, __( 'Add a terminal punctuation to backlinks:', 'footnotes' ) ),
					'terminator-enable'    => $this->add_select_box( Footnotes_Settings::BACKLINKS_TERMINATOR_ENABLED, $enabled ),
					'terminator-options'   => $this->add_select_box( Footnotes_Settings::BACKLINKS_TERMINATOR_OPTION, $terminators ),
					'terminator-custom'    => $this->add_text_box( Footnotes_Settings::BACKLINKS_TERMINATOR_CUSTOM ),
					'notice-terminator'    => __( 'Your input overrides the selection.', 'footnotes' ),

					'label-width'          => $this->add_label( Footnotes_Settings::BACKLINKS_COLUMN_WIDTH_ENABLED, __( 'Set backlinks column width:', 'footnotes' ) ),
					'width-enable'         => $this->add_select_box( Footnotes_Settings::BACKLINKS_COLUMN_WIDTH_ENABLED, $enabled ),
					'width-scalar'         => $this->add_num_box( Footnotes_Settings::BACKLINKS_COLUMN_WIDTH_SCALAR, 0, 500, true ),
					'width-unit'           => $this->add_select_box( Footnotes_Settings::BACKLINKS_COLUMN_WIDTH_UNIT, $width_units ),
					...
					'label-max-width'      => $this->add_label( Footnotes_Settings::BACKLINKS_COLUMN_MAX_WIDTH_ENABLED, __( 'Set backlinks column maximum width:', 'footnotes' ) ),
					'max-width-enable'     => $this->add_select_box( Footnotes_Settings::BACKLINKS_COLUMN_MAX_WIDTH_ENABLED, $enabled ),
					'max-width-scalar'     => $this->add_num_box( Footnotes_Settings::BACKLINKS_COLUMN_MAX_WIDTH_SCALAR, 0, 500, true ),
					'max-width-unit'       => $this->add_select_box( Footnotes_Settings::BACKLINKS_COLUMN_MAX_WIDTH_UNIT, $width_units ),
					...
					'label-line-break'     => $this->add_label( Footnotes_Settings::BACKLINKS_LINE_BREAKS_ENABLED, __( 'Stack backlinks when enumerating:', 'footnotes' ) ),
					'line-break'           => $this->add_select_box( Footnotes_Settings::BACKLINKS_LINE_BREAKS_ENABLED, $enabled ),
					...
					'label-link'           => $this->add_label( Footnotes_Settings::LINK_ELEMENT_ENABLED, __( 'Use the link element for referrers and backlinks:', 'footnotes' ) ),
					'link'                 => $this->add_select_box( Footnotes_Settings::LINK_ELEMENT_ENABLED, $enabled ),
	...
	public function start_end() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'settings-start-end' );
		// Replace all placeholders.
		$template->replace(
			array(
				...
				'label-short-code-start'   => $this->add_label( Footnotes_Settings::FOOTNOTES_SHORT_CODE_START, __( 'Footnote start tag short code:', 'footnotes' ) ),
				'short-code-start'         => $this->add_select_box( Footnotes_Settings::FOOTNOTES_SHORT_CODE_START, $shortcode_start ),
				'short-code-start-user'    => $this->add_text_box( Footnotes_Settings::FOOTNOTES_SHORT_CODE_START_USER_DEFINED ),

				'label-short-code-end'     => $this->add_label( Footnotes_Settings::FOOTNOTES_SHORT_CODE_END, __( 'Footnote end tag short code:', 'footnotes' ) ),
				'short-code-end'           => $this->add_select_box( Footnotes_Settings::FOOTNOTES_SHORT_CODE_END, $shortcode_end ),
				'short-code-end-user'      => $this->add_text_box( Footnotes_Settings::FOOTNOTES_SHORT_CODE_END_USER_DEFINED ),

				// For script showing/hiding user defined text boxes.
				'short-code-start-id'      => Footnotes_Settings::FOOTNOTES_SHORT_CODE_START,
				'short-code-end-id'        => Footnotes_Settings::FOOTNOTES_SHORT_CODE_END,
				'short-code-start-user-id' => Footnotes_Settings::FOOTNOTES_SHORT_CODE_START_USER_DEFINED,
				'short-code-end-user-id'   => Footnotes_Settings::FOOTNOTES_SHORT_CODE_END_USER_DEFINED,
				...
				'label-syntax'             => $this->add_label( Footnotes_Settings::FOOTNOTE_SHORTCODE_SYNTAX_VALIDATION_ENABLE, __( 'Check for balanced shortcodes:', 'footnotes' ) ),
				'syntax'                   => $this->add_select_box( Footnotes_Settings::FOOTNOTE_SHORTCODE_SYNTAX_VALIDATION_ENABLE, $enable ),
	...
	public function numbering() {
		...
		$counter_style = array(
			'arabic_plain'   => __( 'plain Arabic numbers', 'footnotes' ) . $space . '1, 2, 3, 4, 5, &hellip;',
			'arabic_leading' => __( 'zero-padded Arabic numbers', 'footnotes' ) . $space . '01, 02, 03, 04, 05, &hellip;',
			'latin_low'      => __( 'lowercase Latin letters', 'footnotes' ) . $space . 'a, b, c, d, e, &hellip;',
			'latin_high'     => __( 'uppercase Latin letters', 'footnotes' ) . $space . 'A, B, C, D, E, &hellip;',
			'romanic'        => __( 'uppercase Roman numerals', 'footnotes' ) . $space . 'I, II, III, IV, V, &hellip;',
			'roman_low'      => __( 'lowercase Roman numerals', 'footnotes' ) . $space . 'i, ii, iii, iv, v, &hellip;',
		);

		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'settings-numbering' );
		// Replace all placeholders.
		$template->replace(
			array(
				'label-counter-style'   => $this->add_label( Footnotes_Settings::FOOTNOTES_COUNTER_STYLE, __( 'Numbering style:', 'footnotes' ) ),
				'counter-style'         => $this->add_select_box( Footnotes_Settings::FOOTNOTES_COUNTER_STYLE, $counter_style ),

				// Algorithmically combine identicals.
				'label-identical'       => $this->add_label( Footnotes_Settings::COMBINE_IDENTICAL_FOOTNOTES, __( 'Combine identical footnotes:', 'footnotes' ) ),
				'identical'             => $this->add_select_box( Footnotes_Settings::COMBINE_IDENTICAL_FOOTNOTES, $enable ),
	...
	public function scrolling() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'settings-scrolling' );
		// Replace all placeholders.
		$template->replace(
			array(

				'label-scroll-css'          => $this->add_label( Footnotes_Settings::FOOTNOTES_CSS_SMOOTH_SCROLLING, __( 'CSS-based smooth scrolling:', 'footnotes' ) ),
				'scroll-css'                => $this->add_select_box( Footnotes_Settings::FOOTNOTES_CSS_SMOOTH_SCROLLING, $enable ),
				...
				'label-scroll-offset'          => $this->add_label( Footnotes_Settings::FOOTNOTES_SCROLL_OFFSET, __( 'Scroll offset:', 'footnotes' ) ),
				'scroll-offset'                => $this->add_num_box( Footnotes_Settings::FOOTNOTES_SCROLL_OFFSET, 0, 100 ),
				'notice-scroll-offset'         => __( 'per cent viewport height from the upper edge', 'footnotes' ),

				'label-scroll-duration'        => $this->add_label( Footnotes_Settings::FOOTNOTES_SCROLL_DURATION, __( 'Scroll duration:', 'footnotes' ) ),
				'scroll-duration'              => $this->add_num_box( Footnotes_Settings::FOOTNOTES_SCROLL_DURATION, 0, 20000 ),
				...
				'label-scroll-asymmetricity'   => $this->add_label( Footnotes_Settings::FOOTNOTES_SCROLL_DURATION_ASYMMETRICITY, __( 'Enable asymmetric scroll durations:', 'footnotes' ) ),
				'scroll-asymmetricity'         => $this->add_select_box( Footnotes_Settings::FOOTNOTES_SCROLL_DURATION_ASYMMETRICITY, $enable ),
				'notice-scroll-asymmetricity'  => __( 'With this option enabled, scrolling up may take longer than down, or conversely.', 'footnotes' ),

				'label-scroll-down-duration'   => $this->add_label( Footnotes_Settings::FOOTNOTES_SCROLL_DOWN_DURATION, __( 'Scroll-down duration:', 'footnotes' ) ),
				'scroll-down-duration'         => $this->add_num_box( Footnotes_Settings::FOOTNOTES_SCROLL_DOWN_DURATION, 0, 20000 ),
				'notice-scroll-down-duration'  => __( 'milliseconds', 'footnotes' ),

				'label-scroll-down-delay'      => $this->add_label( Footnotes_Settings::FOOTNOTES_SCROLL_DOWN_DELAY, __( 'Scroll-down delay:', 'footnotes' ) ),
				'scroll-down-delay'            => $this->add_num_box( Footnotes_Settings::FOOTNOTES_SCROLL_DOWN_DELAY, 0, 20000 ),
				...
				'label-scroll-up-delay'        => $this->add_label( Footnotes_Settings::FOOTNOTES_SCROLL_UP_DELAY, __( 'Scroll-up delay:', 'footnotes' ) ),
				'scroll-up-delay'              => $this->add_num_box( Footnotes_Settings::FOOTNOTES_SCROLL_UP_DELAY, 0, 20000 ),
	...
	public function hard_links() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'settings-hard-links' );
		// Replace all placeholders.
		$template->replace(
			array(

				'label-hard-links'             => $this->add_label( Footnotes_Settings::FOOTNOTES_HARD_LINKS_ENABLE, __( 'Enable hard links:', 'footnotes' ) ),
				'hard-links'                   => $this->add_select_box( Footnotes_Settings::FOOTNOTES_HARD_LINKS_ENABLE, $enable ),
				...
				'label-footnote'               => $this->add_label( Footnotes_Settings::FOOTNOTE_FRAGMENT_ID_SLUG, __( 'Fragment identifier slug for footnotes:', 'footnotes' ) ),
				'footnote'                     => $this->add_text_box( Footnotes_Settings::FOOTNOTE_FRAGMENT_ID_SLUG ),
				'notice-footnote'              => __( 'This will show up in the address bar after clicking on a hard-linked footnote referrer.', 'footnotes' ),

				'label-referrer'               => $this->add_label( Footnotes_Settings::REFERRER_FRAGMENT_ID_SLUG, __( 'Fragment identifier slug for footnote referrers:', 'footnotes' ) ),
				'referrer'                     => $this->add_text_box( Footnotes_Settings::REFERRER_FRAGMENT_ID_SLUG ),
				'notice-referrer'              => __( 'This will show up in the address bar after clicking on a hard-linked backlink.', 'footnotes' ),

				'label-separator'              => $this->add_label( Footnotes_Settings::HARD_LINK_IDS_SEPARATOR, __( 'ID separator:', 'footnotes' ) ),
				'separator'                    => $this->add_text_box( Footnotes_Settings::HARD_LINK_IDS_SEPARATOR ),
				...
				'label-backlink-tooltips'      => $this->add_label( Footnotes_Settings::FOOTNOTES_BACKLINK_TOOLTIP_ENABLE, __( 'Enable backlink tooltips:', 'footnotes' ) ),
				'backlink-tooltips'            => $this->add_select_box( Footnotes_Settings::FOOTNOTES_BACKLINK_TOOLTIP_ENABLE, $enable ),
				...
				'label-backlink-tooltip-text'  => $this->add_label( Footnotes_Settings::FOOTNOTES_BACKLINK_TOOLTIP_TEXT, __( 'Backlink tooltip text:', 'footnotes' ) ),
				'backlink-tooltip-text'        => $this->add_text_box( Footnotes_Settings::FOOTNOTES_BACKLINK_TOOLTIP_TEXT ),
	...
	public function love() {
		...
		$love = array(
			// Logo only.
			'text-3' => sprintf( '%s', Footnotes_Config::PLUGIN_PUBLIC_NAME ),
			// Logo followed by heart symbol.
			'text-4' => sprintf( '%s %s', Footnotes_Config::PLUGIN_PUBLIC_NAME, Footnotes_Config::LOVE_SYMBOL ),
			// Logo preceded by heart symbol.
			'text-5' => sprintf( '%s %s', Footnotes_Config::LOVE_SYMBOL, Footnotes_Config::PLUGIN_PUBLIC_NAME ),
			// Translators: 2: heart symbol 1: footnotes logogram.
			'text-1' => sprintf( __( 'I %2$s %1$s', 'footnotes' ), Footnotes_Config::PLUGIN_PUBLIC_NAME, Footnotes_Config::LOVE_SYMBOL ),
			// Translators: %s: Footnotes plugin logo.
			'text-6' => sprintf( __( 'This website uses %s.', 'footnotes' ), Footnotes_Config::PLUGIN_PUBLIC_NAME ),
			// Translators: %s: Footnotes plugin logo.
			'text-7' => sprintf( __( 'This website uses the %s plugin.', 'footnotes' ), Footnotes_Config::PLUGIN_PUBLIC_NAME ),
			// Translators: %s: Footnotes plugin logo.
			'text-2' => sprintf( __( 'This website uses the awesome %s plugin.', 'footnotes' ), Footnotes_Config::PLUGIN_PUBLIC_NAME ),
			'random' => __( 'randomly determined display of either mention', 'footnotes' ),
			// Translators: 1: Plugin logo.2: heart symbol.
			'no'     => sprintf( __( 'no display of any "%1$s %2$s" mention in the footer', 'footnotes' ), Footnotes_Config::PLUGIN_PUBLIC_NAME, Footnotes_Config::LOVE_SYMBOL ),
		);

		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'settings-love' );
		// Replace all placeholders.
		$template->replace(
			array(
				// Translators: %s: Footnotes plugin logo.
				'label-love'    => $this->add_label( Footnotes_Settings::FOOTNOTES_LOVE, sprintf( __( 'Tell the world you\'re using %s:', 'footnotes' ), Footnotes_Config::PLUGIN_PUBLIC_NAME ) ),
				'love'          => $this->add_select_box( Footnotes_Settings::FOOTNOTES_LOVE, $love ),
				// Translators: %s: Footnotes plugin logo.
				'label-no-love' => $this->add_text( sprintf( __( 'Shortcode to inhibit the display of the %s mention on specific pages:', 'footnotes' ), Footnotes_Config::PLUGIN_PUBLIC_NAME ) ),
				'no-love'       => $this->add_text( Footnotes_Config::NO_LOVE_SLUG ),
			)
		);
		// Display template with replaced placeholders.
		// phpcs:disable WordPress.Security.EscapeOutput.OutputNotEscaped
	...
	public function excerpts() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'settings-excerpts' );
		// Replace all placeholders.
		$template->replace(
			array(
				'label-excerpts'       => $this->add_label( Footnotes_Settings::FOOTNOTES_IN_EXCERPT, __( 'Process footnotes in excerpts:', 'footnotes' ) ),
				'excerpts'             => $this->add_select_box( Footnotes_Settings::FOOTNOTES_IN_EXCERPT, $excerpt_mode ),
	...
	public function superscript() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'customize-superscript' );
		// Replace all placeholders.
		$template->replace(
			array(
				'label-superscript' => $this->add_label( Footnotes_Settings::FOOTNOTES_REFERRER_SUPERSCRIPT_TAGS, __( 'Display footnote referrers in superscript:', 'footnotes' ) ),
				'superscript'       => $this->add_select_box( Footnotes_Settings::FOOTNOTES_REFERRER_SUPERSCRIPT_TAGS, $enabled ),

				'label-normalize'   => $this->add_label( Footnotes_Settings::FOOTNOTE_REFERRERS_NORMAL_SUPERSCRIPT, __( 'Normalize vertical alignment and font size:', 'footnotes' ) ),
				'normalize'         => $this->add_select_box( Footnotes_Settings::FOOTNOTE_REFERRERS_NORMAL_SUPERSCRIPT, $normalize_superscript ),
				'notice-normalize'  => __( 'Most themes don\'t need this fix.', 'footnotes' ),

				'label-before'      => $this->add_label( Footnotes_Settings::FOOTNOTES_STYLING_BEFORE, __( 'At the start of the footnote referrers:', 'footnotes' ) ),
				'before'            => $this->add_text_box( Footnotes_Settings::FOOTNOTES_STYLING_BEFORE ),

				'label-after'       => $this->add_label( Footnotes_Settings::FOOTNOTES_STYLING_AFTER, __( 'At the end of the footnote referrers:', 'footnotes' ) ),
				'after'             => $this->add_text_box( Footnotes_Settings::FOOTNOTES_STYLING_AFTER ),
	...
	public function label_solution() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'configure-label-solution' );
		// Replace all placeholders.
		$template->replace(
			array(
				...
				'label-selection'         => $this->add_label( Footnotes_Settings::FOOTNOTES_LABEL_ISSUE_SOLUTION, __( 'Solve input label issue:', 'footnotes' ) ),
				'selection'               => $this->add_select_box( Footnotes_Settings::FOOTNOTES_LABEL_ISSUE_SOLUTION, $issue_solutions ),
	...
	public function mouseover_box() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'mouse-over-box-display' );
		// Replace all placeholders.
		$template->replace(
			array(

				'label-enable'            => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_ENABLED, __( 'Display tooltips:', 'footnotes' ) ),
				'enable'                  => $this->add_select_box( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_ENABLED, $enabled ),
				'notice-enable'           => __( 'Formatted text boxes allowing hyperlinks, displayed on mouse-over or tap and hold.', 'footnotes' ),

				'label-alternative'       => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_ALTERNATIVE, __( 'Display alternative tooltips:', 'footnotes' ) ),
				'alternative'             => $this->add_select_box( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_ALTERNATIVE, $enabled ),
				'notice-alternative'      => __( 'Intended to work around a configuration-related tooltip outage.', 'footnotes' ),
				// Translators: %s: Footnotes plugin logo.
				'description-alternative' => sprintf( __( 'These alternative tooltips work around a website related jQuery UI outage. They are low-script but use the AMP incompatible onmouseover and onmouseout arguments, along with CSS transitions for fade-in/out. The very small script is inserted after Footnotes\' internal stylesheet. When this option is enabled, %s does not load jQuery&nbsp;UI nor jQuery&nbsp;Tools.', 'footnotes' ), '<span style="font-style: normal;">' . Footnotes_Config::PLUGIN_PUBLIC_NAME . '</span>' ),
	...
	public function mouseover_box_position() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'mouse-over-box-position' );
		// Replace all placeholders.
		$template->replace(
			array(

				'label-position'       => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_POSITION, __( 'Position:', 'footnotes' ) ),
				'position'             => $this->add_select_box( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_POSITION, $position ),
				'position-alternative' => $this->add_select_box( Footnotes_Settings::FOOTNOTES_ALTERNATIVE_MOUSE_OVER_BOX_POSITION, $alternative_position ),
				'notice-position'      => __( 'The second column of settings boxes is for the alternative tooltips.', 'footnotes' ),

				'label-offset-x'       => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_OFFSET_X, __( 'Horizontal offset:', 'footnotes' ) ),
				'offset-x'             => $this->add_num_box( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_OFFSET_X, -500, 500 ),
				'offset-x-alternative' => $this->add_num_box( Footnotes_Settings::FOOTNOTES_ALTERNATIVE_MOUSE_OVER_BOX_OFFSET_X, -500, 500 ),
				...
				'label-offset-y'       => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_OFFSET_Y, __( 'Vertical offset:', 'footnotes' ) ),
				'offset-y'             => $this->add_num_box( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_OFFSET_Y, -500, 500 ),
				'offset-y-alternative' => $this->add_num_box( Footnotes_Settings::FOOTNOTES_ALTERNATIVE_MOUSE_OVER_BOX_OFFSET_Y, -500, 500 ),
	...
	public function mouseover_box_dimensions() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'mouse-over-box-dimensions' );
		// Replace all placeholders.
		$template->replace(
			array(

				'label-max-width'  => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_MAX_WIDTH, __( 'Maximum width:', 'footnotes' ) ),
				'max-width'        => $this->add_num_box( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_MAX_WIDTH, 0, 1280 ),
				'width'            => $this->add_num_box( Footnotes_Settings::FOOTNOTES_ALTERNATIVE_MOUSE_OVER_BOX_WIDTH, 0, 1280 ),
	...
	public function mouseover_box_timing() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'mouse-over-box-timing' );
		// Replace all placeholders.
		$template->replace(
			array(

				'label-fade-in-delay'      => $this->add_label( Footnotes_Settings::MOUSE_OVER_BOX_FADE_IN_DELAY, __( 'Fade-in delay:', 'footnotes' ) ),
				'fade-in-delay'            => $this->add_num_box( Footnotes_Settings::MOUSE_OVER_BOX_FADE_IN_DELAY, 0, 20000 ),
				'notice-fade-in-delay'     => __( 'milliseconds', 'footnotes' ),

				'label-fade-in-duration'   => $this->add_label( Footnotes_Settings::MOUSE_OVER_BOX_FADE_IN_DURATION, __( 'Fade-in duration:', 'footnotes' ) ),
				'fade-in-duration'         => $this->add_num_box( Footnotes_Settings::MOUSE_OVER_BOX_FADE_IN_DURATION, 0, 20000 ),
				'notice-fade-in-duration'  => __( 'milliseconds', 'footnotes' ),

				'label-fade-out-delay'     => $this->add_label( Footnotes_Settings::MOUSE_OVER_BOX_FADE_OUT_DELAY, __( 'Fade-out delay:', 'footnotes' ) ),
				'fade-out-delay'           => $this->add_num_box( Footnotes_Settings::MOUSE_OVER_BOX_FADE_OUT_DELAY, 0, 20000 ),
				'notice-fade-out-delay'    => __( 'milliseconds', 'footnotes' ),

				'label-fade-out-duration'  => $this->add_label( Footnotes_Settings::MOUSE_OVER_BOX_FADE_OUT_DURATION, __( 'Fade-out duration:', 'footnotes' ) ),
				'fade-out-duration'        => $this->add_num_box( Footnotes_Settings::MOUSE_OVER_BOX_FADE_OUT_DURATION, 0, 20000 ),
	...
	public function mouseover_box_truncation() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'mouse-over-box-truncation' );
		// Replace all placeholders.
		$template->replace(
			array(

				'label-truncation'  => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_EXCERPT_ENABLED, __( 'Truncate the note in the tooltip:', 'footnotes' ) ),
				'truncation'        => $this->add_select_box( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_EXCERPT_ENABLED, $enabled ),

				'label-max-length'  => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_EXCERPT_LENGTH, __( 'Maximum number of characters in the tooltip:', 'footnotes' ) ),
				'max-length'        => $this->add_num_box( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_EXCERPT_LENGTH, 3, 10000 ),
				// The feature trims back until the last full word.
				'notice-max-length' => __( 'No weird cuts.', 'footnotes' ),

				'label-readon'      => $this->add_label( Footnotes_Settings::FOOTNOTES_TOOLTIP_READON_LABEL, __( '\'Read on\' button label:', 'footnotes' ) ),
				'readon'            => $this->add_text_box( Footnotes_Settings::FOOTNOTES_TOOLTIP_READON_LABEL ),
	...
	public function mouseover_box_text() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'mouse-over-box-text' );
		// Replace all placeholders.
		$template->replace(
			array(
				...
				'label-delimiter'       => $this->add_label( Footnotes_Settings::FOOTNOTES_TOOLTIP_EXCERPT_DELIMITER, __( 'Delimiter for dedicated tooltip text:', 'footnotes' ) ),
				'delimiter'             => $this->add_text_box( Footnotes_Settings::FOOTNOTES_TOOLTIP_EXCERPT_DELIMITER ),
				'notice-delimiter'      => __( 'If the delimiter shortcode is present, the tooltip text will be the part before it.', 'footnotes' ),

				'label-mirror'          => $this->add_label( Footnotes_Settings::FOOTNOTES_TOOLTIP_EXCERPT_MIRROR_ENABLE, __( 'Mirror the tooltip in the reference container:', 'footnotes' ) ),
				'mirror'                => $this->add_select_box( Footnotes_Settings::FOOTNOTES_TOOLTIP_EXCERPT_MIRROR_ENABLE, $enabled ),
				...
				'label-separator'       => $this->add_label( Footnotes_Settings::FOOTNOTES_TOOLTIP_EXCERPT_MIRROR_SEPARATOR, __( 'Separator between tooltip text and footnote text:', 'footnotes' ) ),
				'separator'             => $this->add_text_box( Footnotes_Settings::FOOTNOTES_TOOLTIP_EXCERPT_MIRROR_SEPARATOR ),
	...
	public function mouseover_box_appearance() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'mouse-over-box-appearance' );
		// Replace all placeholders.
		$template->replace(
			array(

				'label-font-size'         => $this->add_label( Footnotes_Settings::MOUSE_OVER_BOX_FONT_SIZE_ENABLED, __( 'Set font size:', 'footnotes' ) ),
				'font-size-enable'        => $this->add_select_box( Footnotes_Settings::MOUSE_OVER_BOX_FONT_SIZE_ENABLED, $enabled ),
				'font-size-scalar'        => $this->add_num_box( Footnotes_Settings::MOUSE_OVER_BOX_FONT_SIZE_SCALAR, 0, 50, true ),
				'font-size-unit'          => $this->add_select_box( Footnotes_Settings::MOUSE_OVER_BOX_FONT_SIZE_UNIT, $font_size_units ),
				'notice-font-size'        => __( 'By default, the font size is set to equal the surrounding text.', 'footnotes' ),

				'label-color'             => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_COLOR, __( 'Text color:', 'footnotes' ) ),
				'color'                   => $this->add_color_selection( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_COLOR ),
				...
				'label-background'        => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_BACKGROUND, __( 'Background color:', 'footnotes' ) ),
				'background'              => $this->add_color_selection( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_BACKGROUND ),
				// Translators: %s: Clear or leave empty.
				...
				'label-border-width'      => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_BORDER_WIDTH, __( 'Border width:', 'footnotes' ) ),
				'border-width'            => $this->add_num_box( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_BORDER_WIDTH, 0, 4, true ),
				'notice-border-width'     => __( 'pixels; 0 for borderless', 'footnotes' ),

				'label-border-color'      => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_BORDER_COLOR, __( 'Border color:', 'footnotes' ) ),
				'border-color'            => $this->add_color_selection( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_BORDER_COLOR ),
				// Translators: %s: Clear or leave empty.
				...
				'label-border-radius'     => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_BORDER_RADIUS, __( 'Rounded corner radius:', 'footnotes' ) ),
				'border-radius'           => $this->add_num_box( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_BORDER_RADIUS, 0, 500 ),
				'notice-border-radius'    => __( 'pixels; 0 for sharp corners', 'footnotes' ),

				'label-box-shadow-color'  => $this->add_label( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_SHADOW_COLOR, __( 'Box shadow color:', 'footnotes' ) ),
				'box-shadow-color'        => $this->add_color_selection( Footnotes_Settings::FOOTNOTES_MOUSE_OVER_BOX_SHADOW_COLOR ),
				// Translators: %s: Clear or leave empty.
	...
	public function hyperlink_arrow() {
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'customize-hyperlink-arrow' );
		// Replace all placeholders.
		$template->replace(
			array(
				'label-symbol'       => $this->add_label( Footnotes_Settings::HYPERLINK_ARROW, __( 'Select or input the backlink symbol:', 'footnotes' ) ),
				'symbol-options'     => $this->add_select_box( Footnotes_Settings::HYPERLINK_ARROW, Footnotes_Convert::get_arrow() ),
				'symbol-custom'      => $this->add_text_box( Footnotes_Settings::HYPERLINK_ARROW_USER_DEFINED ),
	...
	public function custom_css() {
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'customize-css' );
		// Replace all placeholders.
		$template->replace(
			array(
				'label-css'       => $this->add_label( Footnotes_Settings::CUSTOM_CSS, __( 'Your existing Custom CSS code:', 'footnotes' ) ),
				'css'             => $this->add_textarea( Footnotes_Settings::CUSTOM_CSS ),
				...
				// "class-1" => $this->add_text(__("superscript, Footnotes index", Footnotes_Config::PLUGIN_NAME)),.

				// "label-class-2" => ".footnote_tooltip",.
				// "class-2" => $this->add_text(__("mouse-over box, tooltip for each superscript", Footnotes_Config::PLUGIN_NAME)),.

				// "label-class-3" => ".footnote_plugin_index",.
				// "class-3" => $this->add_text(__("1st column of the Reference Container, Footnotes index", Footnotes_Config::PLUGIN_NAME)),.

				// "label-class-4" => ".footnote_plugin_text",.
				// "class-4" => $this->add_text(__("2nd column of the Reference Container, Footnote text", Footnotes_Config::PLUGIN_NAME)).
				// phpcs:enable
			)
		);
		// Display template with replaced placeholders.
	...
	public function custom_css_migration() {
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'customize-css-migration' );
		// Replace all placeholders.
		$template->replace(
			array(
				'label-css'               => $this->add_label( Footnotes_Settings::CUSTOM_CSS, __( 'Your existing Custom CSS code:', 'footnotes' ) ),
				...
				'label-show-legacy'       => $this->add_label( Footnotes_Settings::CUSTOM_CSS_LEGACY_ENABLE, 'Show legacy Custom CSS settings containers:' ),
				'show-legacy'             => $this->add_select_box( Footnotes_Settings::CUSTOM_CSS_LEGACY_ENABLE, $enabled ),
	...
	public function custom_css_new() {
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'customize-css-new' );
		// Replace all placeholders.
		$template->replace(
			array(
				'css'      => $this->add_textarea( Footnotes_Settings::CUSTOM_CSS_NEW ),
	...
	public function lookup_hooks() {
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'expert-lookup' );
		...
		$template->replace(
			array(
				...
				'label-the-title'       => $this->add_label( Footnotes_Settings::EXPERT_LOOKUP_THE_TITLE, 'the_title' ),
				'the-title'             => $this->add_checkbox( Footnotes_Settings::EXPERT_LOOKUP_THE_TITLE ),
				'priority-the-title'    => $this->add_num_box( Footnotes_Settings::EXPERT_LOOKUP_THE_TITLE_PRIORITY_LEVEL, -1, PHP_INT_MAX ),
				'url-the-title'         => 'https://developer.wordpress.org/reference/hooks/the_title/',

				'label-the-content'     => $this->add_label( Footnotes_Settings::EXPERT_LOOKUP_THE_CONTENT, 'the_content' ),
				'the-content'           => $this->add_checkbox( Footnotes_Settings::EXPERT_LOOKUP_THE_CONTENT ),
				'priority-the-content'  => $this->add_num_box( Footnotes_Settings::EXPERT_LOOKUP_THE_CONTENT_PRIORITY_LEVEL, -1, PHP_INT_MAX ),
				'url-the-content'       => 'https://developer.wordpress.org/reference/hooks/the_content/',

				'label-the-excerpt'     => $this->add_label( Footnotes_Settings::EXPERT_LOOKUP_THE_EXCERPT, 'the_excerpt' ),
				'the-excerpt'           => $this->add_checkbox( Footnotes_Settings::EXPERT_LOOKUP_THE_EXCERPT ),
				'priority-the-excerpt'  => $this->add_num_box( Footnotes_Settings::EXPERT_LOOKUP_THE_EXCERPT_PRIORITY_LEVEL, -1, PHP_INT_MAX ),
				'url-the-excerpt'       => 'https://developer.wordpress.org/reference/functions/the_excerpt/',

				'label-widget-title'    => $this->add_label( Footnotes_Settings::EXPERT_LOOKUP_WIDGET_TITLE, 'widget_title' ),
				'widget-title'          => $this->add_checkbox( Footnotes_Settings::EXPERT_LOOKUP_WIDGET_TITLE ),
				'priority-widget-title' => $this->add_num_box( Footnotes_Settings::EXPERT_LOOKUP_WIDGET_TITLE_PRIORITY_LEVEL, -1, PHP_INT_MAX ),
				'url-widget-title'      => 'https://codex.wordpress.org/Plugin_API/Filter_Reference/widget_title',

				'label-widget-text'     => $this->add_label( Footnotes_Settings::EXPERT_LOOKUP_WIDGET_TEXT, 'widget_text' ),
				'widget-text'           => $this->add_checkbox( Footnotes_Settings::EXPERT_LOOKUP_WIDGET_TEXT ),
				'priority-widget-text'  => $this->add_num_box( Footnotes_Settings::EXPERT_LOOKUP_WIDGET_TEXT_PRIORITY_LEVEL, -1, PHP_INT_MAX ),
	...
	public function Help() {
		...
		$footnote_starting_tag = $this->load_setting( Footnotes_Settings::FOOTNOTES_SHORT_CODE_START );
		$footnote_ending_tag   = $this->load_setting( Footnotes_Settings::FOOTNOTES_SHORT_CODE_END );

		if ( 'userdefined' === $footnote_starting_tag['value'] || 'userdefined' === $footnote_ending_tag['value'] ) {
			// Load user defined starting and end tag.
			$footnote_starting_tag = $this->load_setting( Footnotes_Settings::FOOTNOTES_SHORT_CODE_START_USER_DEFINED );
			$footnote_ending_tag   = $this->load_setting( Footnotes_Settings::FOOTNOTES_SHORT_CODE_END_USER_DEFINED );
		}
		...
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'how-to-help' );
		// Replace all placeholders.
		$template->replace(
			array(
				...
				'example'        => $g_obj_mci_footnotes->task->exec( $example, true ),
		 ...
		 * @see class/task.php
		 */
		$g_obj_mci_footnotes->task->footnotes_output_head();
	...
	public function donate() {
		// Load template file.
		$template = new Footnotes_Template( Footnotes_Template::DASHBOARD, 'how-to-donate' );
		// Replace all placeholders.
		$template->replace(
			array(
